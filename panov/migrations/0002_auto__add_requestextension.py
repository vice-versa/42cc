...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RequestExtension'
        db.create_table('panov_requestextension', (
            ('request', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['request.Request'], unique=True, primary_key=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('panov', ['RequestExtension'])


    def backwards(self, orm):
        
        # Deleting model 'RequestExtension'
        db.delete_table('panov_requestextension')
